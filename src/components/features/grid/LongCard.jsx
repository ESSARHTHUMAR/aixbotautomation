    ...
    <div className="col-span-2 h-fit sm:h-[209px]">
      <Card>
        <div className="relative z-20">
          <CalloutChip>API & CRM Integration</CalloutChip>
          <p className="mb-1.5 text-2xl">Connect your data stack</p>
          <p className="max-w-sm text-zinc-400">
            Integrate CRMs and third-party APIs to sync data, automate workflows, and centralize customer insights.
          </p>
        </div>
