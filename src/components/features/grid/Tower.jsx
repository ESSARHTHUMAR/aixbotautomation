  ...
  return (
    <div className="col-span-1 h-[600px] lg:col-span-4 lg:h-[600px]">
      <Card>
        ...
        <CalloutChip>Data Scraping</CalloutChip>
        <p className="mb-2 text-2xl">Unlock data from any website</p>
        <p className="mb-8 text-zinc-400">
          We extract product listings, reviews, directories, and more from public websites with precision and speed.
        </p>
