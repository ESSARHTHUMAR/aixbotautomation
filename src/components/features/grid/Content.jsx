        ...
        <SectionHeadingSpacing>
          <SectionHeading>
            ...
            <span className="bg-gradient-to-br from-blue-400 to-blue-700 bg-clip-text text-transparent">
              with Scraping & Integrations
            </span>
          </SectionHeading>
          <SectionSubheading>
            We deliver web scraping, task automation, bot development, and API & CRM integrations to help you capture data, streamline processes, and ship faster.
          </SectionSubheading>
        </SectionHeadingSpacing>
