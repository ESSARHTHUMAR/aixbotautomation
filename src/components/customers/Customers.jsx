    ...
    <section id="testimonials" className="relative overflow-hidden">
      <MaxWidthWrapper className="relative z-10 py-20 md:py-40">
        <SectionHeadingSpacing>
          <SectionHeading>What <span className="bg-gradient-to-br from-blue-400 to-blue-700 bg-clip-text text-transparent">clients say</span></SectionHeading>
          <SectionSubheading>
            Real results from web scraping, automation, bots, and CRM/API integrations—clean data, faster operations, and measurable impact.
          </SectionSubheading>
        </SectionHeadingSpacing>
        <motion.div
          initial={false}
