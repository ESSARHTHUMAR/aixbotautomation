  ...
  return (
    <section className="relative overflow-hidden border-t border-zinc-700 bg-gradient-to-b from-zinc-900/30 to-zinc-950 py-20">
      <MaxWidthWrapper className="relative z-20 flex flex-col items-center justify-center">
        ...
        >
          <GlowingChip>Free 30-min consult</GlowingChip>
        </motion.div>
        <motion.h1
          initial={{
            y: 25,
          ...
          className="max-w-xl text-center text-3xl font-bold leading-tight text-zinc-50 sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight"
        >
          Get clean data.
        </motion.h1>
        <motion.h1
        ...
        <motion.p
          ...
          className="mb-6 max-w-2xl text-center text-zinc-400"
        >
          Web scraping, automation, bots, and API/CRM integrations done for you - so your team ships faster with reliable data.
        </motion.p>
        <motion.div
          initial={{
            y: 25,
